...
from aditya.modules import ALL_MODULES
from aditya.modules.helper_funcs.chat_status import is_user_admin
from aditya.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("aditya.modules." + module_name)
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Aditya*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Updates Channel @AdityaServer 
                 \n❍ Support Group @AdityaDiscus
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Aditya*
                 \nHere is the [Source Code](https://t.me/AdityaHalder) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
