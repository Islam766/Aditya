...
import aditya.modules.sql.notes_sql as sql
from aditya import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from aditya.__main__ import DATA_IMPORT
from aditya.modules.helper_funcs.chat_status import user_admin
from aditya.modules.helper_funcs.alternate import typing_action

# from aditya.modules.rules import get_rules
import aditya.modules.sql.rules_sql as rulessql

# from aditya.modules.sql import warns_sql as warnssql
import aditya.modules.sql.blacklist_sql as blacklistsql
from aditya.modules.sql import disable_sql as disabledsql

# from aditya.modules.sql import cust_filters_sql as filtersql
# import aditya.modules.sql.welcome_sql as welcsql
import aditya.modules.sql.locks_sql as locksql
from aditya.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("aditya{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("aditya{}.backup".format(chat_id), "rb"),
    ...
    os.remove("aditya{}.backup".format(chat_id))  # Cleaning file
